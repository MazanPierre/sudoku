...
void sauvegarder(PileCoup *historique, int nbCoups, int tailleGrille, int indexGrille){
...
void charger(PileCoup *historique, int *nbCoups, int *tailleGrille, int *indexGrille) {
